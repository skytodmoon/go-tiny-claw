...
func NewSiliconFlowProvider(model string) *SiliconFlowProvider {
	apiKey := os.Getenv("SILICONFLOW_API_KEY")
	if apiKey == "" {
		panic("请设置 SILICONFLOW_API_KEY 环境变量")
	}
...
func (p *SiliconFlowProvider) Generate(ctx context.Context, msgs []schema.Message, availableTools []schema.ToolDefinition) (*schema.Message, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("硅基流动 API 请求失败: %w", err)
	}
