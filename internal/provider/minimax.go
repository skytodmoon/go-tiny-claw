...
func (p *MiniMaxProvider) Generate(ctx context.Context, msgs []schema.Message, availableTools []schema.ToolDefinition) (*schema.Message, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("MiniMax/NVIDIA API 请求失败: %w", err)
	}
